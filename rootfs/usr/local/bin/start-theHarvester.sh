...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210211658-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  start-theHarvester.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Oct 21, 2022 16:58 EDT
# @@File             :  start-theHarvester.sh
# @@Description      :  script to start theHarvester
...
__heath_check() {
  ...
  __curl "http://localhost:$SERVICE_PORT" || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-theHarvester}"
...
SERVICE_COMMAND="/app/restfulHarvest.py -H 0.0.0.0 -p $SERVICE_PORT"
